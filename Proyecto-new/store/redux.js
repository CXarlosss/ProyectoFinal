...
import { Usuario, Comercio } from "../class/Shopclass.js";

/**
 * @typedef {Object} ACTION_TYPES
 ...
 * @param {ACTION_TYPES} action - Acción a reducir.
    ...
    case ACTION_TYPES.FILTER_SERVICES:
      return {
        ...
        serviciosFiltrados: state.comercios.filter((comercio) =>
          comercio.servicios.some((servicio) => typeof action.payload === 'string' && servicio.nombre.includes(action.payload))
        ),
      };
